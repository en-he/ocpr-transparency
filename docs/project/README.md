...
- Phases 0 and 1 are complete: the repository/operating baseline and the available bulk archive have passed their independent, reproducible, CI/Pages, and deployed-freshness gates. Phase 2 live reconciliation/enrichment remains a separate target.
